          ...
          <Reveal delay={0.08}>
            <div className="flex flex-col gap-4 mb-2">
              ...
              <p className="text-xl md:text-2xl text-neutral-400 font-extralight mt-2 tracking-tight">
                I turn bold business ideas into high-performance code and
          ...
          <Stagger className="flex flex-col gap-5" delay={0.12} stagger={0.12}>
            <StaggerItem>
              <p className="text-lg md:text-xl text-neutral-300 font-extralight leading-relaxed mb-4">
                ...
                From tailored feature development to heavy-lift database design,
                I build systems engineered around your unique business logic.
              </p>
            </StaggerItem>
            <StaggerItem>
